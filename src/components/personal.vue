  ...
  <div class="wrapper">
    ...
    <main>
      ...
      <section class="content">
        <mu-list>
          <mu-list-item class="list" v-if="user_msg.recent_topics" title="最近主题" toggleNested :open="false">
            <mu-icon class="icon" slot="left" value="insert_drive_file" />
            <mu-list-item :to="{path:'/content',query:{id:item.id}}" v-for="item in user_msg.recent_topics" :key="item.id" slot="nested" :title="item.title">
        ...
        <mu-list>
          <mu-list-item class="list" v-if="user_msg.recent_replies" title="最近回复" toggleNested :open="false">
            <mu-icon class="icon" slot="left" value="drafts" />
            <mu-list-item :to="{path:'/content',query:{id:item.id}}" v-for="item in user_msg.recent_replies" :key="item.id" slot="nested" :title="item.title">
        ...
        <mu-list>
          <mu-list-item class="list" v-if="user_msg.collect_topics" title="最近主题" toggleNested :open="false">
            <mu-icon class="icon" slot="left" value="folder" />
            <mu-list-item :to="{path:'/content',query:{id:item.id}}" v-for="item in user_msg.collect_topics" :key="item.id" slot="nested" :title="item.title">
      ...
      <mu-raised-button @click="logout" label="退出登录" class="demo-raised-button"  icon="power_settings_news" primary/>
    </main>
